        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT *,CONCAT(lastname, ', ', firstname,' ', COALESCE(middlename)) as `name` from `importer_list` where delete_flag = 0 order by CONCAT(lastname, ', ', firstname,' ', COALESCE(middlename)) asc ");
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this exporter permanently?","delete_client",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
