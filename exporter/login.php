...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h1"><b>exporter Login</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="vlogin-frm" action="" method="post">
        ...
        <div class="row align-item-end">
          ...
          <a href="<?= base_url.'exporter/register.php' ?>">Create an Account</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<script>
  $(function(){
    ...
    $('#vlogin-frm').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Login.php?f=login_exporter",
