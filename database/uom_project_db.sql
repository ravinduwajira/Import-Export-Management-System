...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2023 at 08:00 AM
...
--
-- Database: `uom_project_db`
--

-- --------------------------------------------------------

--
-- Table structure for table `buyerreq_list`
--

CREATE TABLE `buyerreq_list` (
...
INSERT INTO `category_list` (`id`, `exporter_id`, `name`, `description`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
--
-- Table structure for table `exporter_list`
--

CREATE TABLE `exporter_list` (
  `id` int(30) NOT NULL,
...
--
-- Dumping data for table `exporter_list`
--

INSERT INTO `exporter_list` (`id`, `code`, `shop_type_id`, `shop_name`, `shop_owner`, `contact`, `username`, `password`, `avatar`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
--
-- Table structure for table `importer_list`
--

CREATE TABLE `importer_list` (
  `id` int(30) NOT NULL,
  `code` varchar(100) NOT NULL,
...
--
-- Dumping data for table `importer_list`
--

INSERT INTO `importer_list` (`id`, `code`, `firstname`, `middlename`, `lastname`, `gender`, `contact`, `address`, `email`, `password`, `avatar`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
(5, 4, 11, 50, '2023-07-04 00:00:19'),
(5, 1, 5, 1500, '2023-07-04 00:00:19'),
(6, 7, 6, 285.99, '2023-07-04 00:00:19'),
(7, 5, 1, 150, '2023-07-04 01:51:06');
...
INSERT INTO `order_list` (`id`, `code`, `client_id`, `exporter_id`, `total_amount`, `delivery_address`, `status`, `date_created`, `date_updated`) VALUES
...
(5, '202307-00001', 1, 1, 8050, 'This is only my sample address', 0, '2023-07-04 00:00:19', '2023-07-04 00:00:19'),
(6, '202307-00002', 1, 2, 1715.94, 'This is only my sample address', 0, '2023-07-04 00:00:19', '2023-07-04 00:00:19'),
(7, '202307-00003', 1, 1, 150, 'This is only my sample address', 0, '2023-07-04 01:51:06', '2023-07-04 01:51:06');
...
CREATE TABLE `product_list` (
  `id` int(30) NOT NULL,
  `exporter_id` int(30) DEFAULT NULL,
...
INSERT INTO `product_list` (`id`, `exporter_id`, `category_id`, `name`, `description`, `price`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
(1, 'name', 'Sri Lanka Import Export Management System'),
(6, 'short_name', 'SLIEMS'),
(11, 'logo', 'uploads/logo.png'),
(13, 'user_avatar', 'uploads/user_avatar.jpg'),
(14, 'cover', 'uploads/mainImage.jpg');
...
ALTER TABLE `cart_list`
  ...
  ADD KEY `importer_id` (`importer_id`) USING BTREE;
...
ALTER TABLE `category_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vendor_id` (`exporter_id`);

--
-- Indexes for table `exporter_list`
--
ALTER TABLE `exporter_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `shop_type_id` (`shop_type_id`);

--
-- Indexes for table `importer_list`
--
ALTER TABLE `importer_list`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `exporter_list`
--
ALTER TABLE `exporter_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `importer_list`
--
ALTER TABLE `importer_list`
...
--
ALTER TABLE `cart_list`
  ADD CONSTRAINT `cart_list_ibfk_1` FOREIGN KEY (`importer_id`) REFERENCES `importer_list` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `category_list`
  ADD CONSTRAINT `category_list_ibfk_1` FOREIGN KEY (`exporter_id`) REFERENCES `exporter_list` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `exporter_list`
--
ALTER TABLE `exporter_list`
  ADD CONSTRAINT `exporter_list_ibfk_1` FOREIGN KEY (`shop_type_id`) REFERENCES `shop_type_list` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `order_list`
  ADD CONSTRAINT `order_list_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `importer_list` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `order_list_ibfk_2` FOREIGN KEY (`exporter_id`) REFERENCES `exporter_list` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_list`
--
ALTER TABLE `product_list`
  ADD CONSTRAINT `product_list_ibfk_1` FOREIGN KEY (`exporter_id`) REFERENCES `exporter_list` (`id`) ON DELETE SET NULL,
