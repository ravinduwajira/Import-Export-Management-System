            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="p1 text-center">Total Amount (Rs.)</th>
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $orders = $conn->query("SELECT * FROM `order_list` where importer_id = '{$_settings->userdata('id')}' order by `status` asc,unix_timestamp(date_created) desc ");
